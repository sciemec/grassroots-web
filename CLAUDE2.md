...
## 🎯 PLATFORM FOCUS — IDENTIFY · NURTURE · MARKET (JUNE 2026 — UNTIL FURTHER NOTICE)

**This instruction overrides the product roadmap (Phases 1–8) and the May 2026 priority section.**
**It was set by Nigel on 22 June 2026 and remains in force until Nigel explicitly changes it.**

---

### THE MISSION RIGHT NOW

GrassRoots Sports does ONE thing:
> **Find talented players. Develop them. Get them seen.**

Every feature Claude builds must serve one of these three pillars:

---

### PILLAR 1 — IDENTIFY 🔍
*Find talent. Score it. Make it visible.*

Features that belong here:
- GRS Engine (AQ score, 6 domain scores, tier — U13/U16/U19/Senior, male/female)
- The 6 biometric tests (Standing Broad Jump, 20m Sprint, Balance, Reaction, Chitima Run, Ball Mastery)
- Talent Passport (public shareable profile — free)
- Talent Leaderboard
- Scout discovery and pipeline tools
- Biometric scan by coaches
- Player profile (position, age, province, sport)

---

### PILLAR 2 — NURTURE 🌱
*Develop players with structured, grassroots-appropriate training.*

Features that belong here:
- Drill Library (age-adapted, gender-aware, bilingual EN/Shona/Ndebele)
- Drill mastery progress system (sessions to master, milestones, % complete)
- Training session logging (Pitch Mode / Train Now)
- THUTO AI coaching feedback
- Gemini drill video analysis (premium)
- Achievement system (streaks, skill badges, mastery stars)
- Training reminders and progress reports
- Position-specific player academy (Sprint 8)

---

### PILLAR 3 — MARKET 📣
*Get players seen by the right people.*

Features that belong here:
- Arena social feed (activity posts, achievements, highlights)
- Highlight Vault (video uploads to R2, visible to scouts)
- Talent Showcase (share clips publicly)
- Passport share button (WhatsApp-first)
- Scout view notifications ("your passport was viewed")
- Arena discover (scouts find players by position/province/tier)
- "Add to Pipeline" scout action on all player cards

---

### WHAT CLAUDE MUST DO

When Nigel asks for a new feature, Claude MUST:

1. **State which pillar it belongs to** before writing any code
2. **Build it** following all existing architecture rules
3. **Connect it to Arena** — every meaningful action feeds the Arena activity feed
4. **Connect it to the Passport** — achievements and skills earned appear on the Passport
5. **Make it bilingual** — all user-facing text must support EN / ChiShona / isiNdebele via i18next

If a feature does NOT belong to Identify, Nurture, or Market — **do not build it without Nigel's explicit instruction.**

---

### WHAT IS PAUSED — DO NOT BUILD THESE

The following features are **paused** until the three pillars are complete and working.
Claude must NOT build any of these unless Nigel explicitly says "resume [feature name]":

| Feature | Why paused |
|---------|-----------|
| Live match streaming (Phase 6) | Not core to player development |
| Multi-sport expansion (Phase 7) | Football first — validate before expanding |
| Video Studio full build (Phase 8) | Gemini drill analysis covers this for now |
| Match fixtures and results | Coach tool — not player development |
| Offline PWA / Service Workers (Phase 5) | Technical debt — not user-facing value |
| AI tactical analysis / heatmaps (Phase 4) | Coach feature — not player development |
| ZIFA league structures (Phase 3) | Admin work — not urgent |
| Billing dashboard / subscription management | Payment works — do not over-engineer |
| WhatsApp bot routing | Already built — do not extend |
| Fan Hub features | Not core to Identify/Nurture/Market |
| Coach Hub full rebuild | Coach tools are secondary to player tools |
| PitchPro tactical board extensions | Already built — do not extend |
| Admin dashboard | Not user-facing value |
| Market value calculator | Nice to have — not urgent |

---

### THE BUILD PRIORITY ORDER

When in doubt about what to build next, follow this order:

**1. Fix anything broken in Identify, Nurture, or Market first** (bugs before features)

**2. Complete the Talent Passport end-to-end**
   - Public passport URL working
   - All 6 test scores showing
   - Skills Earned section (mastered drills — free)
   - Share button (WhatsApp native share)
   - Scout view count notification
   - Premium blur on AQ timeline, position quotient, scout narrative

**3. Complete the Drill System**
   - Age-adapted variants (U13/U16/U19/Senior)
   - Gender notes per drill
   - Bilingual instructions (EN/Shona/Ndebele)
   - Zimbabwe-appropriate equipment alternatives (no cones → stone/bottle)
   - Mastery progress system (% complete, milestones, sessions to master)
   - Achievement badges (mastered, streaks, personal bests)

**4. Complete Arena as the activity feed**
   - Every drill completion → Arena post
   - Every achievement → Arena post with achievement card
   - Every AQ score → Arena post
   - Scout actions on player posts (Add to Pipeline, View Passport)

**5. Fix the 6 bugs from the bug report (22 June 2026)**
   - filter() crash, hero card glitch, video upload network error,
     AI coach timeout, camera initialisation, 404 routes

---

### THE TEST — Is This Feature Worth Building Right Now?

Before building ANYTHING, Claude must ask:

> "Does this directly help a grassroots player get identified, developed, or seen by a scout?"

- **YES** → Build it. State which pillar it serves at the top of the response.
- **NO** → Do not build it. Tell Nigel which pillar it would need to serve to become worth building.
- **UNSURE** → Ask Nigel before touching any code.

---

### WHY THIS FOCUS EXISTS

GrassRoots Sports has 50+ routes. The platform is technically impressive.
But a 15-year-old player in Mbare or a girl playing in Bulawayo does not care
about the architecture. She cares about ONE thing:

> **"Will this help me get noticed by a club or academy?"**

Every feature built from now answers YES to that question — or it waits.
...
## SESSION LOG — 22 June 2026 (end of day)

### Theme — Platform Focus: Identify · Nurture · Market

### CHANGES MADE TO CLAUDE.md THIS SESSION

Added the **IDENTIFY · NURTURE · MARKET** focus block at line 468, immediately
before the PRODUCT ROADMAP section.

**This block is now the governing instruction for all future Claude Code sessions.**
It overrides the Phase 1–8 roadmap and the May 2026 priority section.

#### What the block does:
- Defines 3 pillars: Identify (find talent), Nurture (develop players), Market (get seen)
- Maps every existing feature to one of the three pillars
- Pauses 14 feature categories that do not serve the pillars
- Sets a locked build priority order: Passport → Drills → Arena feed → Bug fixes
- Gives Claude a single test to apply before building anything:
  "Does this help a grassroots player get identified, developed, or seen by a scout?"

#### Paused features (do not build until Nigel says resume):
Live streaming · Multi-sport · Video Studio · Match fixtures · Offline PWA ·
AI tactical heatmaps · ZIFA structures · Billing dashboard · WhatsApp bot extensions ·
Fan Hub · Coach Hub rebuild · PitchPro extensions · Admin dashboard · Market value calculator

### BRIEFS PRODUCED THIS SESSION (in /mnt/user-data/outputs/)
- grs-bug-fixes.md — 6 bug fixes for 22 June errors
- passport-completion-brief.md — Talent Passport end-to-end
- drill-enrichment-brief.md — enriched drill cards + Gemini measurement
- arena-activity-feed-brief.md — connect all features to Arena feed
- drill-system-redesign.md — age groups, gender, bilingual, mastery, achievements
- claude-md-priority-block.md — the focus block (now inserted above)

### WHAT STILL NEEDS DOING
- [ ] All 5 briefs above need to be run through Claude Code
- [ ] CLAUDE.md needs to be pushed to GitHub (bhora-ai and grassroots-web)
- [ ] The 6 bugs from the morning session need fixing first before new features
