    ...
    <>
      <style>{`
        ...
        @media (max-width: 640px) {
          .zpb-quote { display: none; }
          .zpb-pip { display: none; }
        }
        @media (max-width: 480px) {
          .zpb-tag { display: none; }
        }
      `}</style>
      ...
      <div className="zpb-outer">
        ...
        <div className="zpb-body">
          ...
          <p className="zpb-quote">
            "Talent must be <strong>identified early, nurtured systematically</strong> — afforded opportunity regardless of geography or background."
          </p>
    ...
    <>
      <style>{`
        ...
        .zis-wrap::after {
          ...
          position: absolute; inset: 0;
          background-image:
            repeating-linear-gradient(-55deg, transparent, transparent 24px,
        ...
        .zis-coa-ring {
          ...
          position: relative;
          box-shadow:
            0 0 40px rgba(0,100,0,0.25),
            0 0 80px rgba(0,100,0,0.1),
        ...
        @media (max-width: 480px) {
          .zis-inner { padding: 44px 18px 38px; gap: 24px; }
        }
      `}</style>
          ...
          <div className="zis-coa" style={fade(0.2)}>
            <div className="zis-coa-ring">
              <svg className="zis-bird" viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Zimbabwe Soapstone Bird — stylised */}
                {/* Crown */}
...
// ─────────────────────────────────────────────
// USAGE PREVIEW — shows both together
// ─────────────────────────────────────────────
export default function ZimIndependencePreview() {
  return (
    <div style={{ fontFamily: 'sans-serif', background: '#1a2e1f', minHeight: '100vh' }}>
      {/* BANNER: goes at very top of your layout, above <Navbar /> */}
      <ZimPresidentBanner />

      {/* Simulated page content */}
      <div style={{
        background: 'linear-gradient(180deg, #0d2010 0%, #1a3a20 100%)',
        minHeight: '60vh',
      ...
      {/* SECTION: goes above "Start Your Journey Today" CTA at bottom */}
      <ZimIndependenceSection />

      {/* Simulated CTA */}
      <div style={{
        background: '#0d1f10', padding: '48px 24px',
        display: 'flex', alignItems: 'center', justifyContent: 'center'
      }}>
        <div style={{
          background: '#006400', color: '#FFD700',
          fontFamily: 'Bebas Neue, sans-serif',
