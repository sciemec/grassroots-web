        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] font-bold uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.45)" }}>Coach Hub</p>
            </div>
          </div>
          ...
          <div className="relative px-5 pt-6 pb-5"
            ...
            <div className="relative flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <h2 className="text-2xl font-black text-white mt-0.5 leading-tight truncate">{user.name || "Coach"}</h2>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-medium mt-0.5" style={{ color: "rgba(255,255,255,0.5)" }}>Top-ranked players in your area</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-medium mt-0.5" style={{ color: "rgba(255,255,255,0.5)" }}>Network · Post · Recruit players</p>
              </div>
            </div>
