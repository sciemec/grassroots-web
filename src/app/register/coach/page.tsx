    ...
    <div className="min-h-screen bg-[#f4f2ee] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-amber-600 rounded-2xl mb-3">
            <Users size={24} className="text-white" />
          </div>
          <h1 className="text-2xl font-black text-gray-900">Join as a Coach</h1>
          <p className="text-sm text-gray-500 mt-1">Manage your squad. Build champions.</p>
        </div>
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <button
                ...
                onClick={() => setStep(2)}
                className="w-full bg-amber-600 disabled:bg-gray-200 disabled:text-gray-400 text-white py-2.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-colors"
              >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2.5 pr-10 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-500"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 ${
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  ...
                  className="flex-1 bg-amber-600 disabled:bg-gray-200 disabled:text-gray-400 text-white py-2.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-colors"
                >
                  {isSubmitting ? (
