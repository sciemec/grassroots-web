...
export default function RegisterFanPage() {
  ...
  const canProceedStep1 =
    ...
    form.country !== "";
    // Note: fans can be any age (5+) — they are supporters, not professionals
                ...
                {form.contactType === "email" ? (
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <input
                      ...
                      className="flex-1 px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
                    />
                  </div>
                )}
              </div>
