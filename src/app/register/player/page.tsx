          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input type={showCfm ? "text" : "password"} placeholder="••••••••" value={form.confirm_password}
            ...
            <div className="space-y-5">
              ...
              <label className="flex cursor-pointer items-start gap-3">
                ...
                <span className="text-sm text-green-200">
                  I agree to the <Link href="/terms" className="text-green-400 underline">Terms of Service</Link> and{" "}
          ...
          <div className="mt-6 flex gap-3">
            ...
            <button onClick={handleNext} disabled={loading}
              ...
              {loading
                ...
                : step === 5
                  ? <><CheckCircle2 className="h-4 w-4" /> Create Player Account</>
