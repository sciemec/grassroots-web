      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        {!user && !isClosed && (
          <div className="bg-white rounded-2xl border border-gray-200 p-5">
            <p className="font-semibold text-sm text-gray-900 mb-1">Interested in this listing?</p>
            <p className="text-xs text-gray-500 mb-3">Sign in or create a free player account to apply.</p>
            <div className="flex gap-2">
              <a href="/login" className="flex-1 py-2.5 rounded-xl text-white text-sm font-semibold text-center" style={{ background: GRS_GREEN }}>Sign in →</a>
              <a href="/register" className="flex-1 py-2.5 rounded-xl text-sm font-semibold text-center border" style={{ borderColor: GRS_GREEN, color: GRS_GREEN }}>Join free →</a>
            </div>
          </div>
        )}
