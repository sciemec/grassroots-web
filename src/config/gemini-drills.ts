...
Return ONLY valid JSON, no markdown, no extra text:
{
...

  {
    ...
    emoji: '💨',
    positions: [],
    description: 'Maximum-effort sprint over 20–30m. THUTO analyses your running form, not just how fast you are.',
...
Return ONLY valid JSON, no markdown, no extra text:
{
...

  {
    ...
    emoji: '📡',
    positions: [],
    description: 'Short and medium passes to a target or partner. THUTO reads body shape, foot surface, and follow-through.',
    ...
    geminiPrompt: `You are analysing hurdle clearance in athletics. Watch all frames and return ONLY valid JSON:
{
  ...
  "data_confidence": "<high|medium|low>"
    ...
    reelSlot: 'technical',
    coachNote: 'Use 3+ hurdles in sequence so THUTO can see rhythm. Film from the side.',
