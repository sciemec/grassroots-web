...
import { Home, Search, Wind, Heart, FileText } from "lucide-react";

const NAV = [
  { href: "/scout",           icon: Home,     label: "Hub"       },
  { href: "/scout/discover",  icon: Search,   label: "Discover"  },
  { href: "/warmup",          icon: Wind,     label: "Warm-Up"   },
  { href: "/scout/shortlist", icon: Heart,    label: "Shortlist" },
  { href: "/scout/reports",   icon: FileText, label: "Reports"   },
];
