...
import {
  UserCircle, Users, Target, Heart, Trophy,
  Settings, LogOut, Menu, X, Globe, ArrowLeft,
  Dumbbell, Activity, Calendar, Camera,
} from "lucide-react";
...
export function LandingSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 w-80 h-screen bg-[#1a5c2a] text-white flex flex-col transition-transform duration-300 ease-in-out shadow-2xl ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        {/* Header */}
        <div className="p-5 border-b border-[#f0b429]/10 shrink-0">
        ...
        {/* User Info */}
        {user && (
          <div className="p-4 border-b border-[#f0b429]/10 shrink-0 bg-white/5">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-[#f0b429]/10 shrink-0 space-y-3">
          {user ? (
            <button
          ...
          <div className="text-center">
            <p className="text-[7px] text-white/20">© 2026 GrassRoots Sports</p>
            <p className="text-[7px] text-white/20 mt-0.5">Identify · Nurture · Market</p>
          </div>
        </div>
      </aside>
    </>
