...
import { Home, Users, Flame, Wind, Calendar } from "lucide-react";

const NAV = [
  { href: "/coach",            icon: Home,     label: "Hub"     },
  { href: "/coach/squad",      icon: Users,    label: "Squad"   },
  { href: "/coach/live-match", icon: Flame,    label: "Live"    },
  { href: "/warmup",           icon: Wind,     label: "Warm-Up" },
  { href: "/coach/matches",    icon: Calendar, label: "Matches" },
];
