...
import { Home, Search, Wind, Globe, Heart } from "lucide-react";

const NAV = [
  { href: "/fan",           icon: Home,   label: "Hub"      },
  { href: "/fan/discover",  icon: Search, label: "Discover" },
  { href: "/warmup",        icon: Wind,   label: "Warm-Up"  },
  { href: "/arena",         icon: Globe,  label: "Arena"    },
  { href: "/fan/following", icon: Heart,  label: "Following"},
];
